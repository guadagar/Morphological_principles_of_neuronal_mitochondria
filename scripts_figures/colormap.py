...
mycolors = viridis(np.linspace(0, 1, 256))
pink = np.array([248/256, 24/256, 148/256, 1])
black = np.array([0/256, 0/256, 0/256, 1])
newcolors[:25, :] = pink
newcmp = ListedColormap(newcolors)
mycolors[0:128, :] = black
mycolors[128:256, :] = pink
pnkblk = ListedColormap(mycolors)

Spectral_r = cm.get_cmap('Spectral_r', 256)
oldcolors = Spectral_r(np.linspace(0.5, 1, 256))
pos_cmap = ListedColormap(oldcolors)
...
colormapDict = {
  ...
  'P_SPECTRAL_R': pos_cmap,
  #'N_SPECTRAL_R': neg_cmap,
}
